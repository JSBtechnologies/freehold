...
export const unlock: (a: number, b: number, c: number, d: number) => any;
export const unlock_recovery: (a: number, b: number, c: number, d: number) => any;
