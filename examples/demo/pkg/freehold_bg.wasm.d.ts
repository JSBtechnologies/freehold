...
export const device_id_from_pubkey: (a: number, b: number) => [number, number, number, number];
export const device_keygen: () => [number, number, number, number];
...
export const session_issue_device_cert: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
...
export const verify_device_cert: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
